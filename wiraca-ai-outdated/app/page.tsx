  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(to right, #0474C4, #06457F)" }}
      >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl md:text-2xl mb-8">
                Transcribe, analyze, and transform your meetings with AI-powered
                tools.
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div
              ...
              style={{ backgroundColor: "rgba(168, 196, 236, 0.2)" }}
            >
              <div
                className="w-12 h-12 rounded-full flex items-center justify-center mb-4"
                style={{ backgroundColor: "rgba(4, 116, 196, 0.2)" }}
              >
                <svg
              ...
              <p style={{ color: "rgba(38, 43, 64, 0.8)" }}>
                Record meetings directly in your browser and get accurate
                transcriptions with speaker diarization.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ color: "rgba(38, 43, 64, 0.8)" }}>
                Use your own API keys for AssemblyAI and Gemini. Full control
            ...
            >
              ...
              <h3
                ...
                style={{ color: "#262B40" }}
              >
                Creative Output Transformation
              </h3>
              <p style={{ color: "rgba(38, 43, 64, 0.8)" }}>
                Transform transcripts into summaries, action items, and email
                drafts with AI-powered tools.
              </p>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        style={{ backgroundColor: "rgba(44, 68, 76, 0.1)" }}
      >
        <div className="max-w-6xl mx-auto">
          <h2
          ...
          <p
            ...
            style={{ color: "rgba(38, 43, 64, 0.8)" }}
          >
            Extend Wicara AI's functionality with our growing collection of
            plugins. Pay only for the features you need.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <span className="font-medium" style={{ color: "#0474C4" }}>
                  Rp 79.000/bulan
                </span>
                <button
                  className="px-4 py-2 rounded transition-colors"
                  style={{ backgroundColor: "#0474C4", color: "#ffffff" }}
                >
                  Learn More
                </button>
              </div>
            ...
            >
              ...
              <p className="mb-4" style={{ color: "rgba(38, 43, 64, 0.8)" }}>
                Share meeting summaries and action items directly to Slack
                channels.
              </p>
              <div className="flex justify-between items-center">
                <span className="font-medium" style={{ color: "#0474C4" }}>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8">
            Get started with Wicara AI today. No credit card required for the
            free tier.
          </p>
          <Link
            href="/(auth)/register"
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div
            ...
            style={{
              borderTop: "1px solid rgba(38, 43, 64, 0.3)",
              color: "#A8C4EC",
            }}
          >
            <p>
