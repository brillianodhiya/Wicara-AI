        ...
        <div className="lg:col-span-2">
          <div className="bg-white p-4 rounded-lg shadow mb-6">
            ...
            <div className="bg-gray-100 h-24 rounded flex items-center justify-center">
              <p className="text-gray-500">Audio player will be displayed here</p>
            </div>
          </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-4 rounded-lg shadow mb-6">
            ...
            <div className="space-y-2">
              ...
              <p><span className="font-medium">Duration:</span> -</p>
              <p><span className="font-medium">Speakers:</span> -</p>
            </div>
          </div>
